...
import com.work.service.RatingService;
...
public class RatingController {
	...
	public ResponseEntity<List<Rating>> getProductsRating(@PathVariable("productId") Long productId,@RequestHeader("Authorization") String jwt)throws
